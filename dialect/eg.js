...
module.exports = {
    ...
    timeout: {
        ...
        invalidDuration: `**${warning} يعم اكتب صيغة الوقت بشكل صحيح، مثلا: \`1m/1d/1h\` **`,
        durationExceed: `**${warning} يعم هوا عملك ايه؟ المهم مده تايم اوت اخرها 28 يوم ي فنان \;)**`,
        success: {
        ...
        cannotSelf: `**${warning} ثباحو عسل عاوز تدي نفسك تايم ازاي يعني؟.**`,
        cannotBot: `**${warning} وصل بيك الحال انك تحاول تديني تايم؟ ليه كدا بس \:(.**`,
        ...
        invalidAction: `**${incorrect} تسوي خوي؟. استخدم 'set' أو 'remove'.**`,
    },
    ban: {
        userNotFound: user_not_found,
        success: {
        ...
        cannotSelf: `**${warning} عاوز تدي نفسك بان؟ لا حول ولا قوة إلا بالله.**`,
        cannotBot: `**${warning} انتظر قليلا... عاوز تبندني ياحامد؟ لو قلبك جايبك لم حبايبك وتعال دعم واشتكي لو في حاجه غلط.**`,
        ...
        invalidAction: `**${incorrect} تسوي خوي؟. استخدم 'give' أو 'remove'.**`,
    ...
    unban: {
        ...
        no_premium: `**${warning}لازم يكون متوفر اشتراك بريميم، حدث خطتك واستخدم الامر مره اخري.**`,
    ...
    disconnect: {
        ...
        no_premium: `لازم اشتراك بريميم عشان تستخدم الميزة دي.`
    },
